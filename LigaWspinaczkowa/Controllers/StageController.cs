...
namespace LigaWspinaczkowa.Controllers
{
    ...
    public class StageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataFrom,DataTo,Name")] Stage stage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataFrom,DataTo,Name")] Stage stage)
        {
            if (id != stage.Id)
            {
                return NotFound();
